...
GSUB lookup types 1/2/3/4/5/6/7 (single/multiple/alternate/ligature/contextual/
chaining/extension substitution) are rebuilt for remapped subsets; other
...
- Layout/color/variation tables that reference glyph IDs are not subset yet
  ...
  lookup types 1/2/3/4/5/6/7, and `kern` format 0/2/3); they are only preserved when the
