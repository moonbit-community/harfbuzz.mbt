...
- `subset`: TrueType subsetting for glyf/loca/hmtx/head/hhea/maxp/cmap (composite remap; long loca) + CFF/CFF2 cmap-only.
...
| `subset` | Subsetting pipeline | `hb-subset*` | done (TrueType glyf/loca + CFF/CFF2 cmap-only) |
